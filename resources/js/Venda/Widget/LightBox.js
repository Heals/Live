...
Venda.Widget.Lightbox.showImageware = function() {
	...
	if(!Venda.Widget.Lightbox.wait) {Venda.Widget.Lightbox.loadingPanel();}
	...
	ajaxFunction(Venda.Widget.Lightbox.config.hrefPath + '&layout=lightbox', Venda.Widget.Lightbox.tempContainer, undefined, function() {
		...
		//start fix width and height of lighbox to fit the flash
		 var lightboxcontent_panel_css = {
		 "width" : Venda.Widget.Lightbox.config.flWidth,
		 "height" : Venda.Widget.Lightbox.config.flHeight,
		 "padding" : "0",
		 "background" : "transparent"
		 }
		jQuery("#lightboxcontent_panel").css("border","0");
		jQuery("#lightboxcontent_panel .bd").css(lightboxcontent_panel_css);
		jQuery("#lightboxflash").css("width",Venda.Widget.Lightbox.config.flWidth);
		jQuery("#lightboxcontent_panel .container-close").css("display","none");
		// end fix width and height of lighbox to fit the flash
